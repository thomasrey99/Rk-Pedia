...
export default function Filters() {
  ...
  const selectStyle =
    "bg-[var(--space)]/50 backdrop-blur-sm border border-[var(--solid)] text-[var(--white)] placeholder-[var(--grey)] rounded-lg px-3 py-2 sm:py-3 text-xs sm:text-base focus:outline-none focus:ring-2 focus:ring-[var(--green)] focus:border-transparent transition-all duration-200";
